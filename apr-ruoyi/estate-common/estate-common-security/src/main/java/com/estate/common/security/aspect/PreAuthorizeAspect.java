package com.estate.common.security.aspect;
...
public class PreAuthorizeAspect {
     ...
     * 所有权限标识
     */
    private static final String ALL_PERMISSION = "*:*:*"; // 没改之前是 *:*:* 这样也不会出错
    ...
    @Around("@annotation(com.estate.common.security.annotation.PreAuthorize)")
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (!StringUtils.isEmpty(annotation.hasPermi())) {
            ...
            throw new AccessDeniedException("用户没有权限,不允许访问,请联系管理员");
