...
import com.zebra.common.utils.uuid.IdUtils;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ConfigServerApplication.getProfile();
    ...
    {
        int dirLastIndex = ConfigServerApplication.getProfile().length() + 1;
