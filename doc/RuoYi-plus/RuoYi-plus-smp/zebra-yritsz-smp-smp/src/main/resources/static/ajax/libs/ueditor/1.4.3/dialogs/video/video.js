...
(function () {
    ...
    function createPreviewVideo(url) {
        ...
        $G("preview").innerHTML = '<p><video class="edui-upload-video  vjs-default-skin video-js" '
            + ' width="' + 420 + '"' +
            ' height="' + 280 + '"' +
            ' controls="" preload="none" width="420" height="280" src="' + url + '" data-setup="{}">'
            + '<source src="' + url + '" type="video/com/large/tos-cn-i-0004/7cdd484660f847fa804b8c3a740b76b0"/>'
            + '</video></p>';
    }
