...
public class MyTenantLineHandler implements TenantLineHandler {
     ...
     * 排除过滤的表
     */
    private static final String[] tableList = {"tables", "columns", "sys_tenant",
    "sys_config", "sys_logininfor","sys_job", "sys_job_log", "sys_menu", "sys_role_dept",
    "sys_role","sys_role_menu", "sys_user_role", "sys_user_post", "sys_user_role",
