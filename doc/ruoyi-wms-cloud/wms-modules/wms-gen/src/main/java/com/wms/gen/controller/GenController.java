package com.wms.gen.controller;
...
import com.wms.common.log.annotation.Log;
import com.wms.common.log.enums.BusinessType;
import com.wms.common.security.annotation.PreAuthorize;
import com.wms.gen.service.IGenTableColumnService;
import com.wms.gen.service.IGenTableService;
...
public class GenController extends BaseController
{
    ...
    public AjaxResult importTableSave(String tables)
    {
        ...
        genTableService.importGenTable(tableList, dbname);
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"wms.zip\"");
