...
$(document).ready(function(){
	...
	$.validator.addMethod("isSmll", function(value, element) {    
		var length = value.length;    
		return this.optional(element) || (/^([1-9][0-9]{0,1}|100)$/.test(value));    
	}, "百分比为1-100间整数"),
	...
	$.validator.addMethod("isMoney", function(value, element) {
		return this.optional(element) || (/^0\.([1-9]|\d[1-9])$|^[1-9]\d{0,8}\.\d{0,2}$|^[1-9]\d{0,8}$/.test(value)); 
	}, "请输入正确金钱格式（保留两位小数）"),
